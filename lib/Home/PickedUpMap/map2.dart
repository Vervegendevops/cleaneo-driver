...
class _PickupMap2State extends State<PickupMap2> {
  ...
  Future<Object> fetchResponse() async {
    final url =
        'https://drycleaneo.com/CleaneoDriver/api/user_vendor/${widget.order['OrderID']}';
  ...
  Future<void> getPolyPoints() async {
    ...
    try {
      PolylineResult result = await polylinePoints.getRouteBetweenCoordinates(
          ...
          PointLatLng(double.parse(widget.order['VendorLatitude']),
              double.parse(widget.order['VendorLongitude'])),
        ...
        child: GoogleMap(
          ...
          markers: {
            ...
            Marker(
                ...
                position: LatLng(double.parse(widget.orders['VendorLatitude']),
                    double.parse(widget.orders['VendorLongitude'])),

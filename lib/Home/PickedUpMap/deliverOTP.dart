...
class DeliveryOTPage extends StatefulWidget {
  String orderID;
  DeliveryOTPage({Key? key, required this.orderID}) : super(key: key);

  @override
  State<DeliveryOTPage> createState() => _DeliveryOTPageState();
}

class _DeliveryOTPageState extends State<DeliveryOTPage> {
  ...
  Future<void> _triggerApiCall() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print('hello');
        Navigator.push(context, MaterialPageRoute(builder: (context) {
          return OrderDeliveredPage(); // here the Summary Page
          // will be open
        }));
      } else {
        // API call failed
  ...
  Future<Object> fetchResponse() async {
    final url =
        'https://drycleaneo.com/CleaneoDriver/api/updateOrder/${widget.orderID}';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print('done');
        _triggerApiCall();
        // https://drycleaneo.com/CleaneoDriver/api/updateOrder/000000124
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ///////////
                        Text(
                          "Sent to ${userVendor['VendorPhone']}",
...
class OTPBox2 extends StatelessWidget {
